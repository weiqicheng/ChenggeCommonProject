package com.chengge.admin.controller;

import com.chengge.admin.annotation.SysLog;
import com.chengge.admin.base.BaseController;
import com.chengge.admin.base.MySysUser;
import com.chengge.admin.entity.Menu;
import com.chengge.admin.entity.User;
import com.chengge.admin.util.Constants;
import com.chengge.admin.util.RestResponse;
import com.chengge.admin.util.VerifyCodeUtil;
...
public class LoginController extends BaseController {
	...
	public String main(Model model){
		...
		Set<com.chengge.admin.entity.Menu> menus = user.getMenus();
		java.util.List<com.chengge.admin.entity.Menu> showMenus = Lists.newArrayList();
...
class MenuComparator implements Comparator<com.chengge.admin.entity.Menu>{

	@Override
	public int compare(com.chengge.admin.entity.Menu o1, com.chengge.admin.entity.Menu o2) {
